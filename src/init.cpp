...
// consensus/s5b-testing: this is a consensus-testing build (height-840,000
// fork commitment + sig_fork_id rules compiled in, S5/b scenario). Refuse to
...
bool CheckMainnetTestingGuard()
{
    ...
    if (!allowed) {
        return InitError(_(
            "This is a consensus-testing build (height-840,000 fork rules, S5/b scenario). "
...
bool AppInitMain(const util::Ref& context, NodeContext& node, interfaces::BlockAndHeaderTipInfo* tip_info)
{
    ...
    // consensus/s5b-testing: self-identify in the P2P-visible subversion
    ...
    uacomments.push_back("s5b-testing-rc1");
