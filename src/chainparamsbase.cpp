...
void SetupChainParamsBaseOptions(ArgsManager& argsman)
{
    ...
    argsman.AddArg("-terminalheight=<n>", "Set the height at which this release stops and shuts down. 0 disables the terminal halt. Test chains only: on mainnet the terminal height is compiled in and this option is refused. (test-chains-only)", ArgsManager::ALLOW_ANY | ArgsManager::DEBUG_ONLY, OptionsCategory::DEBUG_TEST);
    argsman.AddArg("-terminalwarninglead=<n>", "How many blocks before the terminal height the persistent shutdown warning begins. (test-chains-only)", ArgsManager::ALLOW_ANY | ArgsManager::DEBUG_ONLY, OptionsCategory::DEBUG_TEST);
