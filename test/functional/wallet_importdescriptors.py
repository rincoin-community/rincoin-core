...
class ImportDescriptorsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        addresses += ["rrin1qrd3n235cj2czsfmsuvqqpr3lu6lg0ju75ghv3x", "rrin1qfqeppuvj0ww98r6qghmdkj70tv8qpchenfqg3j"] # wpkh subscripts corresponding to the above addresses
        ...
        addresses = [
            'rrin1qtmp74ayg7p24uslctssvjm06q5phz4yrzvsr2e', # m/0'/0'/0
            'rrin1q8vprchan07gzagd5e6v9wd7azyucksq2zgk30j', # m/0'/0'/1
            'rrin1qtuqdtha7zmqgcrr26n2rqxztv5y8rafj94hhxf', # m/0'/0'/2
            'rrin1qau64272ymawq26t90md6an0ps99qkrseshn3v6', # m/0'/0'/3
            'rrin1qsg97266hrh6cpmutqen8s4s962aryy77k38z36', # m/0'/0'/4
        ]
        ...
        assert_equal(addr, 'rrin1qdt0qy5p7dzhxzmegnn4ulzhard33s2809arjqgjndx87rv5vd0fqr9w073') # Derived at m/84'/0'/0'/0
        change_addr = wmulti_priv.getrawchangeaddress('bech32')
        assert_equal(change_addr, 'rrin1qt9uhe3a9hnq7vajl7a094z4s3crm9ttf8zw3f5v9gr2nyd7e3lnsdgeta0')
        ...
        assert_equal(addr, 'rrin1qp8s25ckjl7gr6x2q3dx3tn2pytwp05upkjztk6ey857tt50r5aeq68h5en') # Derived at m/84'/0'/0'/1
