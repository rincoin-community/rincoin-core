...
class UacommentTest(BitcoinTestFramework):
    ...
    def run_test(self):
        # consensus/s6b-testing: this build always stamps a fixed
        # "s6b-testing-rc1" marker as the first uacomment component (see the
        ...
        assert subversion.endswith("(s6b-testing-rc1; testnode0)/"), subversion

        self.restart_node(0, ["-uacomment=foo"])
        subversion = self.nodes[0].getnetworkinfo()["subversion"]
        assert subversion.endswith("(s6b-testing-rc1; testnode0; foo)/"), subversion
